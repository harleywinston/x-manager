...
func (tr *ResourceTests) TestAdd(t *testing.T) {
	tests := []httpTestType{
		...
		// 		ForeignBridges: "162.159.129.81:long-tooth-0da8.harleywinston19935891.workers.dev:long-tooth-0da8.harleywinston19935891.workers.dev",
		// 		ServerIp:       "167.235.27.246",
		// 		Domains:        "alireza-baneshi.ir, somerandom.aslfk",
		// 		Bridges:        "test.darkube.ir",
		// 	},
